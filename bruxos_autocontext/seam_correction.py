...
class H3SeamCorrection(io.ComfyNode):
    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            node_id="BruxosH3AutoContextSeamCorrection",
            display_name="H3 Auto Chunks · Corrigir Emenda (Bruxos)",
            category="Bruxos do VFX/MiniMax H3/Auto Chunks",

            description=(
                "Correção clássica de emendas do MiniMax H3: alinha movimento com "
                "fluxo óptico, mistura a transição e aproxima cor/exposição local."
            ),
            ...
            inputs=[
                ...
                io.Image.Input(
                    "images",
                    tooltip="Vídeo completo depois do VAE Decode.",
                ),

                io.Boolean.Input(
                    "fix_flash",
                    default=True,
                    tooltip="Corrige flashes curtos e saltos repentinos de luminosidade.",
                ),

                io.Boolean.Input(
                    "fix_exposure",
                    default=True,
                    tooltip="Suaviza diferenças de exposição entre os trechos.",
                ),

                io.Boolean.Input(
                    "fix_motion",
                    default=True,
                    tooltip="Alinha movimento nas emendas usando fluxo óptico.",
                ),

                io.Boolean.Input(
                    "fix_scene_cut",
                    default=False,
                    tooltip="Tenta corrigir cortes de cena. Normalmente mantenha desligado para preservar cortes reais.",
                ),
                ...
                io.Float.Input(
                    ...
                    max=1.0,
                    step=0.01,
                    tooltip="Sensibilidade para detectar uma emenda. Valores menores encontram diferenças mais sutis.",
                ),
                ...
                io.Int.Input(
                    ...
                    max=12,
                    step=1,
                    tooltip="Quantidade de frames antes e depois da emenda usados na mistura.",
                ),
                ...
                io.Float.Input(
                    ...
                    max=1.5,
                    step=0.05,
                    tooltip="Força da compensação de movimento por fluxo óptico.",
                ),
                ...
                io.Float.Input(
                    ...
                    max=1.0,
                    step=0.05,
                    tooltip="Força da correção local de cor e luminosidade.",
                ),
                ...
                io.Int.Input(
                    ...
                    max=30,
                    step=1,
                    tooltip="Iterações do fluxo óptico. Valores maiores são mais lentos.",
                ),
                ...
                io.Int.Input(
                    ...
                    max=5,
                    step=1,
                    tooltip="Níveis da pirâmide de fluxo óptico; níveis maiores capturam deslocamentos mais amplos.",
                ),

                io.Boolean.Input(
                    "use_gpu",
                    default=True,
                    tooltip="Usa CUDA para fluxo óptico e correção das emendas.",
                ),
            ],
